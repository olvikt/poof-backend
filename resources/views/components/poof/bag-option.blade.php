...
<button
    ...
    "
>
    <div class="flex items-center justify-center {{ $count > 1 ? '-space-x-1' : '' }}" data-e2e="bag-icons">
        @for($i = 0; $i < $count; $i++)
    ...
    <div class="mt-2 text-xl font-semibold {{ $active ? 'text-black' : 'text-white' }}">{{ $price }} ₴</div>
