...
<div x-data="{ settingsOpen: false }" class="min-h-dvh bg-[#05070b] text-white flex justify-center">
    <div class="relative w-full max-w-md min-h-dvh flex flex-col bg-[#070a10]">
        ...
        <div class="pointer-events-none fixed bottom-[calc(5.25rem+env(safe-area-inset-bottom))] left-1/2 z-40 h-3 w-full max-w-md -translate-x-1/2 bg-gradient-to-t from-[#070a10]/55 via-[#070a10]/20 to-transparent"></div>

        <nav class="fixed bottom-0 left-1/2 z-50 w-full max-w-md -translate-x-1/2 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
            <div class="rounded-2xl border border-white/20 bg-[#0e1622] p-1.5 shadow-[0_-14px_34px_rgba(0,0,0,0.62)] ring-1 ring-black/35">
