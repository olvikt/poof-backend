            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                ...
                <div x-data="{ show: false }" class="relative">
                    <input
                        ...
                        placeholder="Пароль"
                        required
                        class="w-full rounded-xl bg-white/10 border border-white/10 px-4 py-3 pr-12 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                    />
                    ...
                    <button
                        ...
                        class="absolute inset-y-0 right-0 flex items-center px-4 text-gray-300 transition hover:text-white"
                    >
