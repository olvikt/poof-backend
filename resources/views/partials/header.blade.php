        ...
        <a href="{{ route('client.subscriptions', ['highlight' => 'awaiting-confirmation']) }}"
           ...
           aria-label="Непідтверджені виконання">
            ...
            @if($pendingConfirmationsCount > 0)
                <span class="absolute -right-1 -top-1 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full bg-yellow-400 px-1.5 text-[11px] font-bold text-black">
