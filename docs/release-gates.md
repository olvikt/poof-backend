...
2. `php-tests`
   ...
   - broader Auth / Courier / Livewire suites (excluding promoted `CourierOnlineNavigationSyncTest`, and still including `CourierOnlineSessionStabilityTest`, `CourierOnlineAutoResyncTest`, `CourierBusyUxFlowTest`, plus other focused courier online/livewire regressions);
